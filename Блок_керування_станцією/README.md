...
|----------|---------|---------|
| Вхідна напруга | АКБ 6S Li-ion/LiPo/LiHV (до 26.1 В) | Через XT60 |
...
| Тип відеосигналу | CVBS | Аналоговий композитний |
| Відеообробка | Підсилення / перетворення / фільтрація | Модуль VA-Di-2/4 |
| Регулювання рівня відео | Є | Потенціометр R1 |
| Фільтрація відеошумів | Є | Тумблер SA4 |
| BYPASS режим | Є | Роз'єми XS8–XS9 |
| Інтерфейс TX | Цифровий (диференційний) | Через XS2 |
...
| XS3 (GX12-6) | Керування VRX / периферією | +BAT, GND, диференційна лінія | Опціонально |
| XS4 (GX12-6) | Відеовихід 1 | +BAT, +12В, CVBS | Монітор, окуляри, DVR пристрій для запису відео, пристрій для захоплення та оцифрування відео для стрімів тощо |
| XS5 (GX12-6) | Відеовихід 2 | +BAT, +12В, CVBS | Монітор, окуляри, DVR пристрій для запису відео, пристрій для захоплення та оцифрування відео для стрімів тощо |
| XS6 (GX12-6) | Відеовихід 3 | +BAT, +12В, CVBS | Монітор, окуляри, DVR пристрій для запису відео, пристрій для захоплення та оцифрування відео для стрімів тощо |
| XS7 (GX12-6) | Відеовихід 4 (монітор) | +BAT, +12В, CVBS | Підключення монітору |
| XS8 (GX12-6) | BYPASS (вихід) | +BAT, +12В, CVBS | Пряме підключення |
| XS9 (GX12-6) | BYPASS (вхід) | +BAT, +12В, CVBS | Джерело сигналу |
