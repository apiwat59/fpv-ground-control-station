...
| XS3 (GX12-6) | Підключення VRX1 | +BAT, GND, CVBS, диференційна лінія | Перший відеовхід, підтримує керування через звиту пару |
| XS4 (GX12-6) | Підключення VRX2 | +BAT, GND, CVBS | Додатковий відеовхід |
